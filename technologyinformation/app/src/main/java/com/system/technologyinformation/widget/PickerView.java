...
public class PickerView extends View {
    ...
    private List<ProfessionalTypeBean> mDataList;
    /**
    ...
    public void setData(List<ProfessionalTypeBean> datas) {
        mDataList = datas;
    ...
    private void moveHeadToTail() {
        ProfessionalTypeBean head = mDataList.get(0);
        mDataList.remove(0);
        mDataList.add(head);
    }

    private void moveTailToHead() {
        ProfessionalTypeBean tail = mDataList.get(mDataList.size() - 1);
    ...
    private void init() {
        timer = new Timer();
        mDataList = new ArrayList<ProfessionalTypeBean>();
    ...
    public interface onSelectListener {
        void onSelect(ProfessionalTypeBean text);
    }
}
